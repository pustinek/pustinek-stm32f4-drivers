...
void SPI3_IRQHandler()
{
	...
	pu_spi_irq_handler(&pu_fatfs_spi_handle);
}
...
static void pu_fatfs_init_gpio(void)
{
    ...
    /* Configure GPIOC_PIN_3 for spi SCK functionality */
    ...
    /* configure GPIOC_PIN_5 for SPI MOSI functionality */
    ...
    /* configure GPIOC_PIN_4 for SPI MISO functionality */
